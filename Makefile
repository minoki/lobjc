...
TO_CMOD= objc.so
TO_LMOD= lua/objc.lua lua/objc/typeencoding.lua lua/objc/bridgesupport.lua lua/objc/struct.lua lua/cocoa.lua
...
install:
	...
	cd src && $(INSTALL_DATA) lua/objc/bridgesupport.lua lua/objc/typeencoding.lua lua/objc/struct.lua $(INSTALL_LMOD)/objc
